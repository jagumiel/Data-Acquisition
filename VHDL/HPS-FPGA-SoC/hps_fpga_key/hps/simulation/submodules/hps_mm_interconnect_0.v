...
module hps_mm_interconnect_0 (
		...
		output wire [1:0]  gpio_hps_s1_address,                                                 //                                                   gpio_hps_s1.address
		output wire        gpio_hps_s1_write,                                                   //                                                              .write
		input  wire [31:0] gpio_hps_s1_readdata,                                                //                                                              .readdata
		output wire [31:0] gpio_hps_s1_writedata,                                               //                                                              .writedata
		output wire        gpio_hps_s1_chipselect,                                              //                                                              .chipselect
	...
	wire   [31:0] gpio_hps_s1_agent_m0_readdata;                            // gpio_hps_s1_translator:uav_readdata -> gpio_hps_s1_agent:m0_readdata
	wire          gpio_hps_s1_agent_m0_waitrequest;                         // gpio_hps_s1_translator:uav_waitrequest -> gpio_hps_s1_agent:m0_waitrequest
	wire          gpio_hps_s1_agent_m0_debugaccess;                         // gpio_hps_s1_agent:m0_debugaccess -> gpio_hps_s1_translator:uav_debugaccess
	wire   [20:0] gpio_hps_s1_agent_m0_address;                             // gpio_hps_s1_agent:m0_address -> gpio_hps_s1_translator:uav_address
	wire    [3:0] gpio_hps_s1_agent_m0_byteenable;                          // gpio_hps_s1_agent:m0_byteenable -> gpio_hps_s1_translator:uav_byteenable
	wire          gpio_hps_s1_agent_m0_read;                                // gpio_hps_s1_agent:m0_read -> gpio_hps_s1_translator:uav_read
	wire          gpio_hps_s1_agent_m0_readdatavalid;                       // gpio_hps_s1_translator:uav_readdatavalid -> gpio_hps_s1_agent:m0_readdatavalid
	wire          gpio_hps_s1_agent_m0_lock;                                // gpio_hps_s1_agent:m0_lock -> gpio_hps_s1_translator:uav_lock
	wire   [31:0] gpio_hps_s1_agent_m0_writedata;                           // gpio_hps_s1_agent:m0_writedata -> gpio_hps_s1_translator:uav_writedata
	wire          gpio_hps_s1_agent_m0_write;                               // gpio_hps_s1_agent:m0_write -> gpio_hps_s1_translator:uav_write
	wire    [2:0] gpio_hps_s1_agent_m0_burstcount;                          // gpio_hps_s1_agent:m0_burstcount -> gpio_hps_s1_translator:uav_burstcount
	wire          gpio_hps_s1_agent_rf_source_valid;                        // gpio_hps_s1_agent:rf_source_valid -> gpio_hps_s1_agent_rsp_fifo:in_valid
	wire  [112:0] gpio_hps_s1_agent_rf_source_data;                         // gpio_hps_s1_agent:rf_source_data -> gpio_hps_s1_agent_rsp_fifo:in_data
	wire          gpio_hps_s1_agent_rf_source_ready;                        // gpio_hps_s1_agent_rsp_fifo:in_ready -> gpio_hps_s1_agent:rf_source_ready
	wire          gpio_hps_s1_agent_rf_source_startofpacket;                // gpio_hps_s1_agent:rf_source_startofpacket -> gpio_hps_s1_agent_rsp_fifo:in_startofpacket
	wire          gpio_hps_s1_agent_rf_source_endofpacket;                  // gpio_hps_s1_agent:rf_source_endofpacket -> gpio_hps_s1_agent_rsp_fifo:in_endofpacket
	wire          gpio_hps_s1_agent_rsp_fifo_out_valid;                     // gpio_hps_s1_agent_rsp_fifo:out_valid -> gpio_hps_s1_agent:rf_sink_valid
	wire  [112:0] gpio_hps_s1_agent_rsp_fifo_out_data;                      // gpio_hps_s1_agent_rsp_fifo:out_data -> gpio_hps_s1_agent:rf_sink_data
	wire          gpio_hps_s1_agent_rsp_fifo_out_ready;                     // gpio_hps_s1_agent:rf_sink_ready -> gpio_hps_s1_agent_rsp_fifo:out_ready
	wire          gpio_hps_s1_agent_rsp_fifo_out_startofpacket;             // gpio_hps_s1_agent_rsp_fifo:out_startofpacket -> gpio_hps_s1_agent:rf_sink_startofpacket
	wire          gpio_hps_s1_agent_rsp_fifo_out_endofpacket;               // gpio_hps_s1_agent_rsp_fifo:out_endofpacket -> gpio_hps_s1_agent:rf_sink_endofpacket
	wire          gpio_hps_s1_agent_rdata_fifo_src_valid;                   // gpio_hps_s1_agent:rdata_fifo_src_valid -> gpio_hps_s1_agent_rdata_fifo:in_valid
	wire   [33:0] gpio_hps_s1_agent_rdata_fifo_src_data;                    // gpio_hps_s1_agent:rdata_fifo_src_data -> gpio_hps_s1_agent_rdata_fifo:in_data
	wire          gpio_hps_s1_agent_rdata_fifo_src_ready;                   // gpio_hps_s1_agent_rdata_fifo:in_ready -> gpio_hps_s1_agent:rdata_fifo_src_ready
	...
	wire  [111:0] key_s1_agent_rp_data;                                     // key_s1_agent:rp_data -> router_002:sink_data
	...
	wire          gpio_hps_s1_agent_rp_valid;                               // gpio_hps_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] gpio_hps_s1_agent_rp_data;                                // gpio_hps_s1_agent:rp_data -> router_003:sink_data
	wire          gpio_hps_s1_agent_rp_ready;                               // router_003:sink_ready -> gpio_hps_s1_agent:rp_ready
	wire          gpio_hps_s1_agent_rp_startofpacket;                       // gpio_hps_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          gpio_hps_s1_agent_rp_endofpacket;                         // gpio_hps_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> key_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> key_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // key_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> key_s1_burst_adapter:sink0_endofpacket
	wire          key_s1_burst_adapter_source0_valid;                       // key_s1_burst_adapter:source0_valid -> key_s1_agent:cp_valid
	wire  [111:0] key_s1_burst_adapter_source0_data;                        // key_s1_burst_adapter:source0_data -> key_s1_agent:cp_data
	wire          key_s1_burst_adapter_source0_ready;                       // key_s1_agent:cp_ready -> key_s1_burst_adapter:source0_ready
	wire    [1:0] key_s1_burst_adapter_source0_channel;                     // key_s1_burst_adapter:source0_channel -> key_s1_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> gpio_hps_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> gpio_hps_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // gpio_hps_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> gpio_hps_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> gpio_hps_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> gpio_hps_s1_burst_adapter:sink0_endofpacket
	wire          gpio_hps_s1_burst_adapter_source0_valid;                  // gpio_hps_s1_burst_adapter:source0_valid -> gpio_hps_s1_agent:cp_valid
	wire  [111:0] gpio_hps_s1_burst_adapter_source0_data;                   // gpio_hps_s1_burst_adapter:source0_data -> gpio_hps_s1_agent:cp_data
	wire          gpio_hps_s1_burst_adapter_source0_ready;                  // gpio_hps_s1_agent:cp_ready -> gpio_hps_s1_burst_adapter:source0_ready
	wire    [1:0] gpio_hps_s1_burst_adapter_source0_channel;                // gpio_hps_s1_burst_adapter:source0_channel -> gpio_hps_s1_agent:cp_channel
	wire          gpio_hps_s1_burst_adapter_source0_startofpacket;          // gpio_hps_s1_burst_adapter:source0_startofpacket -> gpio_hps_s1_agent:cp_startofpacket
	wire          gpio_hps_s1_burst_adapter_source0_endofpacket;            // gpio_hps_s1_burst_adapter:source0_endofpacket -> gpio_hps_s1_agent:cp_endofpacket
	...
	wire          gpio_hps_s1_agent_rdata_fifo_out_valid;                   // gpio_hps_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] gpio_hps_s1_agent_rdata_fifo_out_data;                    // gpio_hps_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          gpio_hps_s1_agent_rdata_fifo_out_ready;                   // avalon_st_adapter_001:in_0_ready -> gpio_hps_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> gpio_hps_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> gpio_hps_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // gpio_hps_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> gpio_hps_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) gpio_hps_s1_translator (
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (key_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (gpio_hps_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (gpio_hps_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (gpio_hps_s1_agent_m0_read),             //                         .read
		.uav_write              (gpio_hps_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (gpio_hps_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (gpio_hps_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (gpio_hps_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (gpio_hps_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (gpio_hps_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (gpio_hps_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (gpio_hps_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (gpio_hps_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (gpio_hps_s1_write),                     //                         .write
		.av_readdata            (gpio_hps_s1_readdata),                  //                         .readdata
		.av_writedata           (gpio_hps_s1_writedata),                 //                         .writedata
		.av_chipselect          (gpio_hps_s1_chipselect),                //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (key_reset_reset_bridge_in_reset_reset),           //       clk_reset.reset
		.m0_address              (gpio_hps_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (gpio_hps_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (gpio_hps_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (gpio_hps_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (gpio_hps_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (gpio_hps_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (gpio_hps_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (gpio_hps_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (gpio_hps_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (gpio_hps_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (gpio_hps_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (gpio_hps_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (gpio_hps_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (gpio_hps_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (gpio_hps_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (gpio_hps_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (gpio_hps_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (gpio_hps_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (gpio_hps_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (gpio_hps_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (gpio_hps_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (gpio_hps_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (gpio_hps_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (gpio_hps_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (gpio_hps_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (gpio_hps_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (gpio_hps_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (gpio_hps_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (gpio_hps_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (gpio_hps_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (gpio_hps_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (gpio_hps_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),               //                .error
		.rdata_fifo_src_ready    (gpio_hps_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gpio_hps_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (gpio_hps_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gpio_hps_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (key_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (gpio_hps_s1_agent_rf_source_data),             //        in.data
		.in_valid          (gpio_hps_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (gpio_hps_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (gpio_hps_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (gpio_hps_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (gpio_hps_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (gpio_hps_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (gpio_hps_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (gpio_hps_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (gpio_hps_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gpio_hps_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                          //       clk.clk
		.reset             (key_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (gpio_hps_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (gpio_hps_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (gpio_hps_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (gpio_hps_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (gpio_hps_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (gpio_hps_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                  // (terminated)
		.csr_read          (1'b0),                                   // (terminated)
		.csr_write         (1'b0),                                   // (terminated)
		.csr_readdata      (),                                       // (terminated)
	...
	hps_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (gpio_hps_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (gpio_hps_s1_agent_rp_valid),            //          .valid
		.sink_data          (gpio_hps_s1_agent_rp_data),             //          .data
		.sink_startofpacket (gpio_hps_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (gpio_hps_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (gpio_hps_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (gpio_hps_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (gpio_hps_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (gpio_hps_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (gpio_hps_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (gpio_hps_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	hps_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (key_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (gpio_hps_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (gpio_hps_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (gpio_hps_s1_agent_rdata_fifo_out_ready), //         .ready

	hps u0 (
		...
		.freq_tri_external_export        (<connected-to-freq_tri_external_export>),        // freq_tri_external.export
		.freq_sin_external_export        (<connected-to-freq_sin_external_export>)         // freq_sin_external.export
	);

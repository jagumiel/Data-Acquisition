...
module hps_mm_interconnect_0 (
		...
		input  wire        entrada_0_reset_reset_bridge_in_reset_reset,                         //                         entrada_0_reset_reset_bridge_in_reset.reset
		...
		output wire        entrada_0_avl_read,                                                  //                                                 entrada_0_avl.read
		input  wire [7:0]  entrada_0_avl_readdata,                                              //                                                              .readdata
	...
	wire    [7:0] entrada_0_avl_agent_m0_readdata;                          // entrada_0_avl_translator:uav_readdata -> entrada_0_avl_agent:m0_readdata
	wire          entrada_0_avl_agent_m0_waitrequest;                       // entrada_0_avl_translator:uav_waitrequest -> entrada_0_avl_agent:m0_waitrequest
	wire          entrada_0_avl_agent_m0_debugaccess;                       // entrada_0_avl_agent:m0_debugaccess -> entrada_0_avl_translator:uav_debugaccess
	wire   [20:0] entrada_0_avl_agent_m0_address;                           // entrada_0_avl_agent:m0_address -> entrada_0_avl_translator:uav_address
	wire    [0:0] entrada_0_avl_agent_m0_byteenable;                        // entrada_0_avl_agent:m0_byteenable -> entrada_0_avl_translator:uav_byteenable
	wire          entrada_0_avl_agent_m0_read;                              // entrada_0_avl_agent:m0_read -> entrada_0_avl_translator:uav_read
	wire          entrada_0_avl_agent_m0_readdatavalid;                     // entrada_0_avl_translator:uav_readdatavalid -> entrada_0_avl_agent:m0_readdatavalid
	wire          entrada_0_avl_agent_m0_lock;                              // entrada_0_avl_agent:m0_lock -> entrada_0_avl_translator:uav_lock
	wire    [7:0] entrada_0_avl_agent_m0_writedata;                         // entrada_0_avl_agent:m0_writedata -> entrada_0_avl_translator:uav_writedata
	wire          entrada_0_avl_agent_m0_write;                             // entrada_0_avl_agent:m0_write -> entrada_0_avl_translator:uav_write
	wire    [0:0] entrada_0_avl_agent_m0_burstcount;                        // entrada_0_avl_agent:m0_burstcount -> entrada_0_avl_translator:uav_burstcount
	wire          entrada_0_avl_agent_rf_source_valid;                      // entrada_0_avl_agent:rf_source_valid -> entrada_0_avl_agent_rsp_fifo:in_valid
	wire   [85:0] entrada_0_avl_agent_rf_source_data;                       // entrada_0_avl_agent:rf_source_data -> entrada_0_avl_agent_rsp_fifo:in_data
	wire          entrada_0_avl_agent_rf_source_ready;                      // entrada_0_avl_agent_rsp_fifo:in_ready -> entrada_0_avl_agent:rf_source_ready
	wire          entrada_0_avl_agent_rf_source_startofpacket;              // entrada_0_avl_agent:rf_source_startofpacket -> entrada_0_avl_agent_rsp_fifo:in_startofpacket
	wire          entrada_0_avl_agent_rf_source_endofpacket;                // entrada_0_avl_agent:rf_source_endofpacket -> entrada_0_avl_agent_rsp_fifo:in_endofpacket
	wire          entrada_0_avl_agent_rsp_fifo_out_valid;                   // entrada_0_avl_agent_rsp_fifo:out_valid -> entrada_0_avl_agent:rf_sink_valid
	wire   [85:0] entrada_0_avl_agent_rsp_fifo_out_data;                    // entrada_0_avl_agent_rsp_fifo:out_data -> entrada_0_avl_agent:rf_sink_data
	wire          entrada_0_avl_agent_rsp_fifo_out_ready;                   // entrada_0_avl_agent:rf_sink_ready -> entrada_0_avl_agent_rsp_fifo:out_ready
	wire          entrada_0_avl_agent_rsp_fifo_out_startofpacket;           // entrada_0_avl_agent_rsp_fifo:out_startofpacket -> entrada_0_avl_agent:rf_sink_startofpacket
	wire          entrada_0_avl_agent_rsp_fifo_out_endofpacket;             // entrada_0_avl_agent_rsp_fifo:out_endofpacket -> entrada_0_avl_agent:rf_sink_endofpacket
	wire          entrada_0_avl_agent_rdata_fifo_src_valid;                 // entrada_0_avl_agent:rdata_fifo_src_valid -> entrada_0_avl_agent_rdata_fifo:in_valid
	wire    [9:0] entrada_0_avl_agent_rdata_fifo_src_data;                  // entrada_0_avl_agent:rdata_fifo_src_data -> entrada_0_avl_agent_rdata_fifo:in_data
	wire          entrada_0_avl_agent_rdata_fifo_src_ready;                 // entrada_0_avl_agent_rdata_fifo:in_ready -> entrada_0_avl_agent:rdata_fifo_src_ready
	...
	wire          entrada_0_avl_agent_rp_valid;                             // entrada_0_avl_agent:rp_valid -> router_002:sink_valid
	wire   [84:0] entrada_0_avl_agent_rp_data;                              // entrada_0_avl_agent:rp_data -> router_002:sink_data
	wire          entrada_0_avl_agent_rp_ready;                             // router_002:sink_ready -> entrada_0_avl_agent:rp_ready
	wire          entrada_0_avl_agent_rp_startofpacket;                     // entrada_0_avl_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          entrada_0_avl_agent_rp_endofpacket;                       // entrada_0_avl_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          leds_s1_agent_rp_valid;                                   // leds_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] leds_s1_agent_rp_data;                                    // leds_s1_agent:rp_data -> router_003:sink_data
	...
	wire          entrada_0_avl_burst_adapter_source0_valid;                // entrada_0_avl_burst_adapter:source0_valid -> entrada_0_avl_agent:cp_valid
	wire   [84:0] entrada_0_avl_burst_adapter_source0_data;                 // entrada_0_avl_burst_adapter:source0_data -> entrada_0_avl_agent:cp_data
	wire          entrada_0_avl_burst_adapter_source0_ready;                // entrada_0_avl_agent:cp_ready -> entrada_0_avl_burst_adapter:source0_ready
	wire    [1:0] entrada_0_avl_burst_adapter_source0_channel;              // entrada_0_avl_burst_adapter:source0_channel -> entrada_0_avl_agent:cp_channel
	wire          entrada_0_avl_burst_adapter_source0_startofpacket;        // entrada_0_avl_burst_adapter:source0_startofpacket -> entrada_0_avl_agent:cp_startofpacket
	wire          entrada_0_avl_burst_adapter_source0_endofpacket;          // entrada_0_avl_burst_adapter:source0_endofpacket -> entrada_0_avl_agent:cp_endofpacket
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> leds_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // leds_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> leds_s1_burst_adapter:sink0_channel
	...
	wire          router_002_src_valid;                                     // router_002:src_valid -> entrada_0_avl_rsp_width_adapter:in_valid
	wire   [84:0] router_002_src_data;                                      // router_002:src_data -> entrada_0_avl_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                     // entrada_0_avl_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                   // router_002:src_channel -> entrada_0_avl_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                             // router_002:src_startofpacket -> entrada_0_avl_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                               // router_002:src_endofpacket -> entrada_0_avl_rsp_width_adapter:in_endofpacket
	wire          entrada_0_avl_rsp_width_adapter_src_valid;                // entrada_0_avl_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [111:0] entrada_0_avl_rsp_width_adapter_src_data;                 // entrada_0_avl_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          entrada_0_avl_rsp_width_adapter_src_ready;                // rsp_demux:sink_ready -> entrada_0_avl_rsp_width_adapter:out_ready
	wire    [1:0] entrada_0_avl_rsp_width_adapter_src_channel;              // entrada_0_avl_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          entrada_0_avl_rsp_width_adapter_src_startofpacket;        // entrada_0_avl_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          entrada_0_avl_rsp_width_adapter_src_endofpacket;          // entrada_0_avl_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> entrada_0_avl_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> entrada_0_avl_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                        // entrada_0_avl_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> entrada_0_avl_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> entrada_0_avl_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> entrada_0_avl_cmd_width_adapter:in_endofpacket
	wire          entrada_0_avl_cmd_width_adapter_src_valid;                // entrada_0_avl_cmd_width_adapter:out_valid -> entrada_0_avl_burst_adapter:sink0_valid
	wire   [84:0] entrada_0_avl_cmd_width_adapter_src_data;                 // entrada_0_avl_cmd_width_adapter:out_data -> entrada_0_avl_burst_adapter:sink0_data
	wire          entrada_0_avl_cmd_width_adapter_src_ready;                // entrada_0_avl_burst_adapter:sink0_ready -> entrada_0_avl_cmd_width_adapter:out_ready
	wire    [1:0] entrada_0_avl_cmd_width_adapter_src_channel;              // entrada_0_avl_cmd_width_adapter:out_channel -> entrada_0_avl_burst_adapter:sink0_channel
	wire          entrada_0_avl_cmd_width_adapter_src_startofpacket;        // entrada_0_avl_cmd_width_adapter:out_startofpacket -> entrada_0_avl_burst_adapter:sink0_startofpacket
	wire          entrada_0_avl_cmd_width_adapter_src_endofpacket;          // entrada_0_avl_cmd_width_adapter:out_endofpacket -> entrada_0_avl_burst_adapter:sink0_endofpacket
	...
	wire          entrada_0_avl_agent_rdata_fifo_out_valid;                 // entrada_0_avl_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire    [9:0] entrada_0_avl_agent_rdata_fifo_out_data;                  // entrada_0_avl_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          entrada_0_avl_agent_rdata_fifo_out_ready;                 // avalon_st_adapter:in_0_ready -> entrada_0_avl_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> entrada_0_avl_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> entrada_0_avl_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // entrada_0_avl_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> entrada_0_avl_agent:rdata_fifo_sink_error
	...
	) entrada_0_avl_translator (
		.clk                    (clk_0_clk_clk),                               //                      clk.clk
		.reset                  (entrada_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (entrada_0_avl_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (entrada_0_avl_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (entrada_0_avl_agent_m0_read),                 //                         .read
		.uav_write              (entrada_0_avl_agent_m0_write),                //                         .write
		.uav_waitrequest        (entrada_0_avl_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (entrada_0_avl_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (entrada_0_avl_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (entrada_0_avl_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (entrada_0_avl_agent_m0_writedata),            //                         .writedata
		.uav_lock               (entrada_0_avl_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (entrada_0_avl_agent_m0_debugaccess),          //                         .debugaccess
		.av_read                (entrada_0_avl_read),                          //      avalon_anti_slave_0.read
		.av_readdata            (entrada_0_avl_readdata),                      //                         .readdata
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (entrada_0_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (entrada_0_avl_agent_m0_address),                    //              m0.address
		.m0_burstcount           (entrada_0_avl_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (entrada_0_avl_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (entrada_0_avl_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (entrada_0_avl_agent_m0_lock),                       //                .lock
		.m0_readdata             (entrada_0_avl_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (entrada_0_avl_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (entrada_0_avl_agent_m0_read),                       //                .read
		.m0_waitrequest          (entrada_0_avl_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (entrada_0_avl_agent_m0_writedata),                  //                .writedata
		.m0_write                (entrada_0_avl_agent_m0_write),                      //                .write
		.rp_endofpacket          (entrada_0_avl_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (entrada_0_avl_agent_rp_ready),                      //                .ready
		.rp_valid                (entrada_0_avl_agent_rp_valid),                      //                .valid
		.rp_data                 (entrada_0_avl_agent_rp_data),                       //                .data
		.rp_startofpacket        (entrada_0_avl_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (entrada_0_avl_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (entrada_0_avl_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (entrada_0_avl_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (entrada_0_avl_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (entrada_0_avl_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (entrada_0_avl_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (entrada_0_avl_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (entrada_0_avl_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (entrada_0_avl_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (entrada_0_avl_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (entrada_0_avl_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (entrada_0_avl_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (entrada_0_avl_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (entrada_0_avl_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (entrada_0_avl_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (entrada_0_avl_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (entrada_0_avl_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (entrada_0_avl_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (entrada_0_avl_agent_rdata_fifo_src_data),           //                .data
	...
	) entrada_0_avl_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (entrada_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (entrada_0_avl_agent_rf_source_data),             //        in.data
		.in_valid          (entrada_0_avl_agent_rf_source_valid),            //          .valid
		.in_ready          (entrada_0_avl_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (entrada_0_avl_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (entrada_0_avl_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (entrada_0_avl_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (entrada_0_avl_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (entrada_0_avl_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (entrada_0_avl_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (entrada_0_avl_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) entrada_0_avl_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                               //       clk.clk
		.reset             (entrada_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (entrada_0_avl_agent_rdata_fifo_src_data),     //        in.data
		.in_valid          (entrada_0_avl_agent_rdata_fifo_src_valid),    //          .valid
		.in_ready          (entrada_0_avl_agent_rdata_fifo_src_ready),    //          .ready
		.out_data          (entrada_0_avl_agent_rdata_fifo_out_data),     //       out.data
		.out_valid         (entrada_0_avl_agent_rdata_fifo_out_valid),    //          .valid
		.out_ready         (entrada_0_avl_agent_rdata_fifo_out_ready),    //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	hps_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (entrada_0_avl_agent_rp_ready),                //      sink.ready
		.sink_valid         (entrada_0_avl_agent_rp_valid),                //          .valid
		.sink_data          (entrada_0_avl_agent_rp_data),                 //          .data
		.sink_startofpacket (entrada_0_avl_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (entrada_0_avl_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (entrada_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	) entrada_0_avl_burst_adapter (
		.clk                   (clk_0_clk_clk),                                     //       cr0.clk
		.reset                 (entrada_0_reset_reset_bridge_in_reset_reset),       // cr0_reset.reset
		.sink0_valid           (entrada_0_avl_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (entrada_0_avl_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (entrada_0_avl_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (entrada_0_avl_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (entrada_0_avl_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (entrada_0_avl_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (entrada_0_avl_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (entrada_0_avl_burst_adapter_source0_data),          //          .data
		.source0_channel       (entrada_0_avl_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (entrada_0_avl_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (entrada_0_avl_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (entrada_0_avl_burst_adapter_source0_ready)          //          .ready
	);
	...
	hps_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (entrada_0_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.sink_ready         (entrada_0_avl_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (entrada_0_avl_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (entrada_0_avl_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (entrada_0_avl_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (entrada_0_avl_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (entrada_0_avl_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (entrada_0_avl_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (entrada_0_avl_rsp_width_adapter_src_data),          //          .data
		.out_channel          (entrada_0_avl_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (entrada_0_avl_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (entrada_0_avl_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (entrada_0_avl_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (entrada_0_avl_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (entrada_0_avl_cmd_width_adapter_src_data),          //          .data
		.out_channel          (entrada_0_avl_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (entrada_0_avl_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (entrada_0_avl_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (entrada_0_avl_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                             // (terminated)
	);
	...
	hps_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (entrada_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (entrada_0_avl_agent_rdata_fifo_out_data),     //     in_0.data
		.in_0_valid     (entrada_0_avl_agent_rdata_fifo_out_valid),    //         .valid
		.in_0_ready     (entrada_0_avl_agent_rdata_fifo_out_ready),    //         .ready

...
module nios_system_mm_interconnect_0 (
	...
	wire  [88:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                         // cpu_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [3:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_data_master_agent:rp_channel
	...
	wire  [88:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                     // cpu_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [3:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire  [14:0] adc_adc_slave_agent_m0_address;                                            // ADC_adc_slave_agent:m0_address -> ADC_adc_slave_translator:uav_address
	...
	wire  [89:0] adc_adc_slave_agent_rf_source_data;                                        // ADC_adc_slave_agent:rf_source_data -> ADC_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] adc_adc_slave_agent_rsp_fifo_out_data;                                     // ADC_adc_slave_agent_rsp_fifo:out_data -> ADC_adc_slave_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> ADC_adc_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // ADC_adc_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> ADC_adc_slave_agent:cp_channel
	...
	wire  [14:0] cpu_jtag_debug_module_agent_m0_address;                                    // cpu_jtag_debug_module_agent:m0_address -> cpu_jtag_debug_module_translator:uav_address
	...
	wire  [89:0] cpu_jtag_debug_module_agent_rf_source_data;                                // cpu_jtag_debug_module_agent:rf_source_data -> cpu_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [89:0] cpu_jtag_debug_module_agent_rsp_fifo_out_data;                             // cpu_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_jtag_debug_module_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // cpu_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> cpu_jtag_debug_module_agent:cp_channel
	...
	wire  [89:0] onchip_mem_s1_agent_rf_source_data;                                        // onchip_mem_s1_agent:rf_source_data -> onchip_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] onchip_mem_s1_agent_rsp_fifo_out_data;                                     // onchip_mem_s1_agent_rsp_fifo:out_data -> onchip_mem_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_mem_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // onchip_mem_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [89:0] leds_s1_agent_rf_source_data;                                              // LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] leds_s1_agent_rsp_fifo_out_data;                                           // LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> LEDs_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // LEDs_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire  [88:0] cpu_data_master_agent_cp_data;                                             // cpu_data_master_agent:cp_data -> router:sink_data
	...
	wire  [88:0] cpu_instruction_master_agent_cp_data;                                      // cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [88:0] router_001_src_data;                                                       // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire  [88:0] adc_adc_slave_agent_rp_data;                                               // ADC_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [88:0] router_002_src_data;                                                       // router_002:src_data -> rsp_demux:sink_data
	...
	wire  [88:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire  [88:0] router_003_src_data;                                                       // router_003:src_data -> rsp_demux_001:sink_data
	...
	wire  [88:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [88:0] router_004_src_data;                                                       // router_004:src_data -> rsp_demux_002:sink_data
	...
	wire  [88:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [88:0] cmd_demux_001_src0_data;                                                   // cmd_demux_001:src0_data -> cmd_mux_001:sink1_data
	...
	wire  [88:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_002:sink1_data
	...
	wire  [88:0] rsp_demux_001_src1_data;                                                   // rsp_demux_001:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [88:0] rsp_demux_002_src1_data;                                                   // rsp_demux_002:src1_data -> rsp_mux_001:sink1_data
	...
	wire         cpu_jtag_debug_module_agent_rdata_fifo_src_valid;                          // cpu_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] cpu_jtag_debug_module_agent_rdata_fifo_src_data;                           // cpu_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         cpu_jtag_debug_module_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_001:in_0_ready -> cpu_jtag_debug_module_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> cpu_jtag_debug_module_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> cpu_jtag_debug_module_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // cpu_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> cpu_jtag_debug_module_agent:rdata_fifo_sink_error

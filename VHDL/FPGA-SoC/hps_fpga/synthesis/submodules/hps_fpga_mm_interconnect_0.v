...
module hps_fpga_mm_interconnect_0 (
	...
	wire  [111:0] led_s1_agent_rp_data;                                     // led_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [111:0] sw_s1_agent_rp_data;                                      // sw_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> led_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // led_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> led_s1_burst_adapter:sink0_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> sw_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // sw_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> sw_s1_burst_adapter:sink0_channel
